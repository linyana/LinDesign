var b=Object.defineProperty;var S=(t,e,s)=>e in t?b(t,e,{enumerable:!0,configurable:!0,writable:!0,value:s}):t[e]=s;var v=(t,e,s)=>(S(t,typeof e!="symbol"?e+"":e,s),s);import{r as x,a as n,F as m,j as i,R as C}from"./index.7f2453b5.js";import{S as g}from"./index.0c8e5fda.js";import{w as a}from"./wrong.13f6fc9b.js";/* empty css              */const B=()=>{const t={element:()=>i(E,{}),HTMLCode:d=>`<div${d.trim()?` class="${d.replace(".","")}"`:""}>
