var _=Object.defineProperty;var b=(t,e,s)=>e in t?_(t,e,{enumerable:!0,configurable:!0,writable:!0,value:s}):t[e]=s;var v=(t,e,s)=>(b(t,typeof e!="symbol"?e+"":e,s),s);import{r as o,a as x,F as u,j as i,R as S}from"./index.9a6a449a.js";import{S as p}from"./index.e9ea95cf.js";const B=()=>{const t={element:()=>i(E,{}),HTMLCode:d=>`<div${d.trim()?` class="${d.replace(".","")}"`:""}>
...
class Component extends React.Component {
  ...
  `}})]})]});class A extends S.Component{constructor(s){super(s);v(this,"timer");v(this,"slideIndex",0);v(this,"slideArr",["slide_box active","slide_box next","slide_box","slide_box","slide_box pre"]);this.state={slideArr:this.slideArr}}slideIncrement(){const s=this.slideIndex===0?this.slideArr.length-1:this.slideIndex-1;this.slideArr[s]="slide_box",this.slideIndex=this.slideIndex===this.slideArr.length-1?0:this.slideIndex+1,this.updateSlide()}slideDecrement(){const s=this.slideIndex===this.slideArr.length-1?0:this.slideIndex+1;this.slideArr[s]="slide_box",this.slideIndex=this.slideIndex===0?this.slideArr.length-1:this.slideIndex-1,this.updateSlide()}updateSlide(){this.slideArr[this.slideIndex]="slide_box active";const s=this.slideIndex===this.slideArr.length-1?0:this.slideIndex+1,l=this.slideIndex===0?this.slideArr.length-1:this.slideIndex-1;this.slideArr[s]="slide_box next",this.slideArr[l]="slide_box pre",this.setState({})}componentDidMount(){this.timer=setInterval(()=>{this.slideIncrement()},1e3)}componentWillUnmount(){clearInterval(this.timer)}handleClickLeft(){clearInterval(this.timer),this.slideDecrement(),this.timer=setInterval(()=>{this.slideIncrement()},1e3)}handleClickRight(){clearInterval(this.timer),this.slideIncrement(),this.timer=setInterval(()=>{this.slideIncrement()},1e3)}render(){return i(u,{children:x("div",{className:"slide_component4_content",children:[i("div",{className:this.slideArr[0],children:"1"}),i("div",{className:this.slideArr[1],children:"2"}),i("div",{className:this.slideArr[2],children:"3"}),i("div",{className:this.slideArr[3],children:"4"}),i("div",{className:this.slideArr[4],children:"5"}),i("div",{className:"slide_buttons",children:this.slideArr.map((s,l)=>i("div",{className:this.slideIndex===l?"slide_button slide_button_focus":"slide_button"},l))}),i("div",{className:"slide_left",onClick:()=>{this.handleClickLeft()},children:i("img",{src:m,alt:""})}),i("div",{className:"slide_right",onClick:()=>{this.handleClickRight()},children:i("img",{src:m,alt:""})})]})})}}const Q=()=>x("div",{children:[x("div",{className:"component_big_title",children:["\u8F6E\u64AD\u56FE ",i("span",{children:"Slide"})]}),i(B,{}),i(C,{})]});export{Q as default};
