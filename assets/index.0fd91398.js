import{r as c,a as x,F as a,j as i}from"./index.d85d5daa.js";import{S as p}from"./index.b40fef20.js";const I=()=>{const n={element:()=>i(h,{}),HTMLCode:e=>`<div${e.trim()?` class="${e.replace(".","")}"`:""}>
...
${e===""?"div":e} .next {
...
</div>`,ReactJSCode:()=>`const length = slideArr.length;
  let slideIndex = 4;
  let timer;
  useEffect(() => {
    if (timer) {
  ...
  setTime();`,ReactTSCode:()=>`const length: number = slideArr.length;
  ...
  `},[d,t]=c.exports.useState(["slide_box active","slide_box next","slide_box","slide_box","slide_box pre"]),s=d.length;let l=4,r;return c.exports.useEffect(()=>{r||(r=setInterval(()=>{l++,l=l===s?0:l,t([d[l]="slide_box active",...d]);const e=l===0?s-1:l-1;t([d[e]="slide_box pre",...d]);const o=e===0?s-1:e-1;t([d[o]="slide_box",...d]);const v=l===s-1?0:l+1;t([d[v]="slide_box next",...d])},3e3))},[]),x(a,{children:[i("div",{className:"compontent_title",id:"slide-anchor3",children:"\u65E0\u7F1D\u6EDA\u52A8"}),i("p",{className:"compontent_p",children:"\u5728\u9996\u5C3E\u5207\u6362\u65F6\u65E0\u7F1D\u6EDA\u52A8,\u53EF\u4EE5\u628A\u91CC\u9762\u7684\u6570\u5B57\u66FF\u6362\u4E3A\u56FE\u7247\uFF0C\u672C\u7EC4\u4EF6\u4E0D\u652F\u6301\u81EA\u5B9A\u4E49\u989C\u8272\u3002"}),x("div",{className:"component_box",children:[i("div",{className:"compontent_box_content",children:x("div",{className:"slide_component3_content",children:[i("div",{className:d[5]?d[5]:"slide_box active",children:"1"}),i("div",{className:d[1],children:"2"}),i("div",{className:d[2],children:"3"}),i("div",{className:d[3],children:"4"}),i("div",{className:d[4],children:"5"})]})}),i(p,{code:n})]})]})},h=()=>{const[n,d]=c.exports.useState(["slide_box active","slide_box next","slide_box","slide_box","slide_box pre"]),t=n.length;let s=4,l;return c.exports.useEffect(()=>{l||(l=setInterval(()=>{s++,s=s===t?0:s,d([n[s]="slide_box active",...n]);const r=s===0?t-1:s-1;d([n[r]="slide_box pre",...n]);const e=r===0?t-1:r-1;d([n[e]="slide_box",...n]);const o=s===t-1?0:s+1;d([n[o]="slide_box next",...n])},3e3))},[]),i(a,{children:x("div",{className:"slide_component3_content",children:[i("div",{className:n[5]?n[5]:"slide_box active",children:"1"}),i("div",{className:n[1],children:"2"}),i("div",{className:n[2],children:"3"}),i("div",{className:n[3],children:"4"}),i("div",{className:n[4],children:"5"})]})})},m=()=>x("div",{children:[x("div",{className:"component_big_title",children:["\u8F6E\u64AD\u56FE ",i("span",{children:"Slide"})]}),i(I,{})]});export{m as default};
